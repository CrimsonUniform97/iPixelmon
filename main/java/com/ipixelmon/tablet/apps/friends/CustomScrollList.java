...
/**
 * Created by colby on 11/10/2016.
 */
public abstract class CustomScrollList extends Gui {
    ...
    private boolean drawThumbAllTheTime = false;

    public CustomScrollList(Minecraft mc, int x, int y, int width, int height, int entryHeight, GuiScreen screen)
    {
        this.mc = mc;
    ...
    public void setDrawThumbAllTheTime(boolean drawThumbAllTheTime) {
        this.drawThumbAllTheTime = drawThumbAllTheTime;
    }
...
//            this.drawGradientRect(this.left, this.top, this.right, this.bottom, 0xC0101010, 0xD0101010);
        ...
        if ((extraHeight > 0 || drawThumbAllTheTime) && getSize() > 0)
        {
