...
import com.ipixelmon.tablet.TileIterator;
 ...
 */
public class GalleryGui extends AppGui {

    public GalleryGui(Object[] objects) {
        super(objects);
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        while (tileIterator.hasNext()) {
            ...
            if (tileIterator.getPage() == page) {
                Dimension boundary = GuiUtil.getScaledDimension(new Dimension(wallpaper.getImage().getWidth(), wallpaper.getImage().getHeight()), new Dimension(rec.getWidth() - 24, rec.getHeight()));
    ...
    private void drawViewingWallpaperScreen(int mouseX, int mouseY) {
        Dimension boundary = GuiUtil.getScaledDimension(new Dimension(viewingWallpaper.getImage().getWidth(),
        ...
        GuiUtil.drawImage(trashBounds.getX(), trashBounds.getY(), trashBounds.getWidth(), trashBounds.getHeight());
        mc.getTextureManager().bindTexture(setWallpaperIcon);
        GuiUtil.drawImage(setWallpaperBounds.getX(), setWallpaperBounds.getY(), setWallpaperBounds.getWidth(), setWallpaperBounds.getHeight());
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.translate(-goBackBounds.getWidth() / 2, -goBackBounds.getHeight() / 2, 0f);
            GuiUtil.drawImage(0, 0, goBackBounds.getWidth(), goBackBounds.getHeight());
        }
    ...
    private void drawWallpapers(int mouseX, int mouseY) {
        ...
        GuiUtil.drawImage(folderBounds.getX(), folderBounds.getY(), folderBounds.getWidth(), folderBounds.getHeight());
        mc.getTextureManager().bindTexture(reloadIcon);
        GuiUtil.drawImage(reloadBounds.getX(), reloadBounds.getY(), reloadBounds.getWidth(), reloadBounds.getHeight());
        drawArrows();
    ...
    private void drawArrows() {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.scale(1.4f, 1.4f, 1.4f);
            GlStateManager.translate(-rightBounds.getWidth() / 2, -rightBounds.getHeight() / 2, 0f);
            GuiUtil.drawImage(0, 0, rightBounds.getWidth(), rightBounds.getHeight());
        }
        GlStateManager.popMatrix();
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.scale(1.4f, 1.4f, 1.4f);
            GlStateManager.translate(-leftBounds.getWidth() / 2, -leftBounds.getHeight() / 2, 0f);
            GuiUtil.drawImage(0, 0, leftBounds.getWidth(), leftBounds.getHeight());
        }
        GlStateManager.popMatrix();
    }
